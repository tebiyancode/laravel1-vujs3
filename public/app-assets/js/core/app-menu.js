    ...
    manualScroller: {
      ...
      update: function () {
        ...
        if ($('.main-menu').data('scroll-to-active') === true) {
          ...
          // If active element's top admin is less than 2/3 (66%) of menu height than do not scroll
      ...
      $('.navigation-main')
        .on('mouseenter.app.menu', 'li', function () {
          ...
          if ($body.hasClass('menu-collapsed') && $body.data('menu') != 'vertical-menu-modern') {
            ...
            // fromTop = menu_header_height + $this.admin().top + parseInt($this.css( "border-top" ),10);
            var fromTop;
