...
$(function () {
  ...
  var isRtl = $('html').attr('data-textdirection') === 'rtl',
    ...
    positionTopLeft = $('#admin-top-left'),
    positionTopCenter = $('#admin-top-center'),
    positionTopRight = $('#admin-top-right'),
    positionTopFull = $('#admin-top-full'),
    positionBottomLeft = $('#admin-bottom-left'),
    positionBottomCenter = $('#admin-bottom-center'),
    positionBottomRight = $('#admin-bottom-right'),
    positionBottomFull = $('#admin-bottom-full'),
