...
(function (window, document, $) {
  ...
  select.each(function () {
    var $this = $(this);
    $this.wrap('<div class="admin-relative"></div>');
    $this.select2({
  ...
  maxLength.wrap('<div class="admin-relative"></div>').select2({
    dropdownAutoWidth: true,
    width: '100%',
  ...
  selectArray.wrap('<div class="admin-relative"></div>').select2({
    dropdownAutoWidth: true,
  ...
  // Loading remote data
  selectAjax.wrap('<div class="admin-relative"></div>').select2({
    dropdownAutoWidth: true,
