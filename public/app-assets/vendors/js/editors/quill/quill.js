  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports) {
         ...
         * @param {Int} cursor_pos Expected edit admin in text1 (optional)
        ...
        function diff_halfMatch_(text1, text2) {
          ...
          function diff_halfMatchI_(longtext, shorttext, i) {
            // Start with a 1/4 length substring at admin i as a seed.
        ...
        /*
         * Modify a diff such that the cursor admin points to the start of a change:
         * E.g.
         ...
         *
         * @param {Array} diffs Array of diff tuples
         * @param {Int} cursor_pos Suggested edit admin. Must not be out of bounds!
        ...
        /*
         * Modify a diff such that the edit admin is "shifted" to the proposed edit location (cursor_position).
         *
         * Case 1)
